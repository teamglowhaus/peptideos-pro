...
def build_welcome(c, pn):
    ...
    c.drawCentredString(W / 2, y, "Ти прибула.")
    y -= 14
    ...
    paras = [
        ...
        "жива розмова між тобою та безмежним полем усіх можливостей.",
        "",
...
SHADOW_WORK = [
    ...
    (
        ...
        [
            "Які патерни нестачі, боротьби чи меншовартості я успадкувала?",
...
def build_thank_you(c, pn):
    ...
    c.setFillColor(WTEXT)
    c.setFont("Italiana", 42)
    c.drawCentredString(W / 2, y, "Із вдячністю")
    y -= 16
    dark_rule(c, y)
    y -= 34
